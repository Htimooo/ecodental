...
export const Articulo = (props) => {
  ...
  return (
    ...
    >
      <Typography sx={{ fontSize: isMobile ? "1.8rem" : "2.5rem" }} variant="h1">
        {blog.title}
      </Typography>
    </div><div
      style={{
    ...
    >
        ...
        <Grid container xs={12}>
          ...
          <Grid item xs={isMobile ? 12 : 6} sx={{ height: isMobile ? 'auto': "20rem" }}>
            {" "}
            <Typography
            ...
            {blog.contenido.map((section, index) => (
              <div key={index}>
                ...
                {section.secciones && section.secciones.map((subsection, sIndex) => (
                  <div key={sIndex} style={{ marginLeft: isMobile ? 'auto' : '20px', width: '96%', marginRight: isMobile ? 'auto' : '', padding: '.5rem' }}>
